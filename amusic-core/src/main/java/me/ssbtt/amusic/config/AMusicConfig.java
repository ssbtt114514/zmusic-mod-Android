package me.ssbtt.amusic.config;
...
public class AMusicConfig {
    ...
    public AMusicConfig(File configDir) {
    ...
    public void load() {
        try {
            ...
            log.warn("Failed to load AMusic config, using defaults: {}", e.getMessage());
            data = new ConfigData();
        }
    }
    ...
    public void save() {
        try {
            ...
            log.warn("Failed to save AMusic config: {}", e.getMessage());
        }
    }
