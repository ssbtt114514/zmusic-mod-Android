...
public class PlaylistPlayer {
     ...
     * 尝试在播放器空闲时播放待播歌曲。
     *
     * <p>由 AMusic.onStateChanged 回调调用：当播放器状态变为 STOPPED（MP3 播放完毕）时，
    ...
    /**
     * 播放器停止时的统一处理（由 AMusic.onStateChanged 回调调用）。
     *
