// TODO: 1.17-1.18 可能需要将 GuiGraphics 替换为 PoseStack
...
/**
 * 基于 Cloth Config API 的 AMusic 设置界面（Forge 版本）。
 *
 * @author ssbtt
 * @since 2026-07-25
 */
public class SettingsScreen {
    ...
    public static Screen build(Screen parent) {
        ...
        ConfigBuilder builder = ConfigBuilder.create()
                ...
                .setTitle(Component.translatable("amusic.settings.title"));
        ...
        // ===== 音频分类 =====
        ConfigCategory audioCat = builder.getOrCreateCategory(Component.translatable("amusic.settings.tab.audio"));
        if (config != null) {
        ...
        // ===== 快捷指令分类 =====
        ConfigCategory cmdCat = builder.getOrCreateCategory(Component.translatable("amusic.settings.tab.commands"));
        ...
        // ===== 快捷键分类 =====
        ConfigCategory hotkeyCat = builder.getOrCreateCategory(Component.translatable("amusic.settings.tab.hotkeys"));
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("所有按键均可在原版「按键绑定」中调整，分类为 AMusic"))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("打开设置: " + keyName(AMusicKeys.OPEN_SETTINGS)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("音量增大: " + keyName(AMusicKeys.VOLUME_UP)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("音量减小: " + keyName(AMusicKeys.VOLUME_DOWN)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("静音切换: " + keyName(AMusicKeys.MUTE_TOGGLE)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("上一首: " + keyName(AMusicKeys.PREVIOUS)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("下一首: " + keyName(AMusicKeys.NEXT)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("暂停: " + keyName(AMusicKeys.PAUSE)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("查看历史记录: " + keyName(AMusicKeys.HISTORY)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("查看歌单: " + keyName(AMusicKeys.PLAYLIST)))
                .build());
        hotkeyCat.addEntry(entryBuilder.startTextDescription(Component.literal("调整音量条位置: " + keyName(AMusicKeys.VOLUME_POSITION)))
                .build());
