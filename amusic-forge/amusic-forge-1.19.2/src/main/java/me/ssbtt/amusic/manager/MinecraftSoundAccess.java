package me.ssbtt.amusic.manager;
...
final class MinecraftSoundAccess {
    ...
    private static synchronized void resolve() {
        ...
        try {
            ...
            if (getInstance == null || optionsField == null || getSoundSourceVolume == null
                ...
                log.warn("AMusic could not fully resolve Minecraft sound API via reflection " +
            ...
            log.warn("AMusic failed to resolve Minecraft sound API via reflection", t);
        }
    }
    ...
    static float getRecordsVolume() {
        ...
        try {
            ...
            log.warn("AMusic failed to read records volume via reflection", t);
            return 1.0f;
        }
    }
    ...
    static void stopMusicAndRecords() {
        ...
        try {
            ...
            log.warn("AMusic failed to stop vanilla sounds via reflection", t);
        }
    }
}
