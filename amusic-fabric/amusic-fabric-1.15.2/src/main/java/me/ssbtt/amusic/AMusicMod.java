...
/**
 * Fabric 客户端 Mod 主入口（1.15.2 旧版网络 API + MatrixStack GUI）。
 *
 * <p>负责注册：插件通道（S2C/C2S）、按键绑定、客户端 Tick、HUD 渲染等。</p>
 *
 * <p>注意：1.15.2 使用旧版 Fabric 网络 API（{@code Identifier} + {@code PacketByteBuf}），
...
public class AMusicMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // 注意：1.15.2 没有 ClientReceiveMessageEvents，聊天链接捕获功能不可用
