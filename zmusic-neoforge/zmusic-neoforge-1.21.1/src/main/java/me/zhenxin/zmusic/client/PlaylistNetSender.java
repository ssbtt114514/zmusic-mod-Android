...
import me.zhenxin.zmusic.playlist.PlaylistShare;
 ...
 * 歌单网络请求发送器。
 *
 * <p>通过 ZMusic 插件通道（{@code zmusic:channel}）向服务端发送歌单相关请求。</p>
 *
 * <p>数据包格式（客户端→服务端）：</p>
 * <ul>
...
public class PlaylistNetSender {
    ...
    private static void send(String message) {
        ...
        try {
            listener.send(new ZMusicPayload(message));
